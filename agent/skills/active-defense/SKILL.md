...
2. **Connection Auditing**: Comparing active connections against a known "safe" list.
3. **Sentiment Analysis of System Logs**: Searching for "fail," "denied," "unauthorized" in system logs.

### Phase 3: Defensive Action
1. **Alerting**: High-priority notifications for critical hardware states.
2. **Containment**: Recommendation to kill suspicious PIDs.
